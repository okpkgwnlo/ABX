...
function Not()
    ...
    Text = "คุณลืมเลือกอาวุธ"; -- what the text says (ofc)
...
function Fot()
    game.StarterGui:SetCore("SendNotification", {
    Title = "Liver Hub"; -- the title (ofc)
    Text = "คุณลืมเลือกผลปีศาจ"; -- what the text says (ofc)
    Icon = "rbxassetid://57254792"; -- the image if u want. 
    Duration = 2; -- how long the notification should in secounds 
    })
end
function Sec()
    game.StarterGui:SetCore("SendNotification", {
    Title = "Liver Hub"; -- the title (ofc)
    Text = "ก็อปปี้โค้ดสำเร็จ"; -- what the text says (ofc)
...
function Wea()
    game.StarterGui:SetCore("SendNotification", {
    Title = "Liver Hub"; -- the title (ofc)
    Text = "เลือกอาวุธ - สำเร็จ"; -- what the text says (ofc)
    Icon = ""; -- the image if u want. 
    Duration = 2; -- how long the notification should in secounds
    })
end
function Fse()
    game.StarterGui:SetCore("SendNotification", {
    Title = "Liver Hub"; -- the title (ofc)
    Text = "เลือกผล - สำเร็จ"; -- what the text says (ofc)
    Icon = ""; -- the image if u want. 
...
function Next()
    game.StarterGui:SetCore("SendNotification", {
    Title = "Liver Hub"; -- the title (ofc)
    Text = "มาเร็วๆนี้แน่นอน"; -- what the text says (ofc)
    Icon = ""; -- the image if u want. 
    Duration = 2; -- how long the notification should in secounds
    })
end
